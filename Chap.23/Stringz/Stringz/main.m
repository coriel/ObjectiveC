...
int main(int argc, const char * argv[]) {
    @autoreleasepool {
        ...
        NSData *readData = [NSData dataWithContentsOfFile:@"/Users/coriel/Desktop/google.png"];
